...
<head>
    ...
    <!-- CSS: Menu separado -->
    <link rel="stylesheet" href="/deltavistoria_projeto2/public/css/menu.css">
    <!-- CSS: Estilos gerais -->
    <link rel="stylesheet" href="/deltavistoria_projeto2/public/css/style.css">
    <link rel="stylesheet" href="/deltavistoria_projeto2/public/css/principal.css">
</head>
<body>
    <header class="header">
        <div class="container">
            <div class="logo">
                <a href="<?php echo $base_url; ?>/public/index.php" class="logo-link">
                    <img src="/deltavistoria_projeto2/public/img/logo_br.png" alt="Delta Vistoria Logo" class="logo-img">
                </a>
            </div>
